...
int sayı;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arraylist=new ImageView[]{imageView,imageView1,imageView2,imageView3,imageView4,imageView5,
        ...
        new CountDownTimer(10000,1000) {
           ...
           süre.setText("süre"+l/1000);
            }

            @Override
            public void onFinish() {
                süre.setText("süre bitti");
                handler.removeCallbacks(runnable);
                for (ImageView image : arraylist){
    ...
    public void tikla(View v){
        sayı++;
        skor.setText("skor"+sayı);



    }
    public void kennysakla(){
        handler=new Handler();
        runnable=new Runnable() {
            ...
            public void run() {
                ...
                arraylist[i].setVisibility(View.VISIBLE );
